...
- NOTE: There is **no starter code** for this assignment (only starter text), but a **sample** solution is [provided](https://github.com/ga-students/FEWD-DC-20/tree/master/Week_01_Basics/Assignment/solution).  Students will build this assignment from scratch and should feel free to get creative with regard to layout, color, styling, etc.

- Slides from [class 1](https://github.com/ga-students/FEWD-DC-20/blob/master/Week_01_Basics/01_html_basics/slides.md) and [class 2](https://github.com/ga-students/FEWD-DC-20/blob/master/Week_01_Basics/02_css_basics/slides.md).
...
![Joe's About](info/about_me_deliverable.png)

- Joe, the freelance developer's "portfolio page":

![Joe's Portfolio](info/portfolio_deliverable.png)
